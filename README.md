...
runtime bootstrap 경로까지 연결되어 있으며, 아직 한국어 특화 품질 개선 로직은 붙지 않은 상태입니다.
...
- 다만 아직 한국어 tokenization, ranking, embedding defaults 같은 차별화 로직은 구현되지 않았습니다
...
다음 스프린트에서는 지금 만들어 둔 owned command 경계와 I/O parity contract를 유지한 채,
