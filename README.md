...
즉, 아직 장기 roadmap이 모두 닫힌 완성 도구는 아니지만, `search/query/update/embed/status`
...
- `search/query/update/embed/status`는 fixed stub가 아니라 owned runtime과 local formatter contract 위에서 동작합니다
